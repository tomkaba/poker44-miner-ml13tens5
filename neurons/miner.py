    ...
    def __init__(self, config=None):
        ...
        self.model_manifest = build_local_model_manifest(
            ...
            implementation_files=[
                repo_root / "weights" / "gen13_tens5_hardened.ts",
            ...
            defaults={
                "model_name": "poker44_ml13tens5",
                "model_version": "13.5",
                "framework": "pytorch-torchscript",
                "license": "MIT",
                "repo_url": "https://github.com/tomkaba/poker44-miner-ml13tens5",
                "repo_commit": git_commit,
                "notes": "Gen13Tens5 neural network scorer",
                "open_source": True,
